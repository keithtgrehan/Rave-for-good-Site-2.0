      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="max-w-4xl mb-20 md:mb-32">
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <Droplets size={16} className="text-primary/70" />
            <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-primary/70">Flagship Initiative</span>
          </motion.div>
          <motion.h1
          ...
          >
            Project:<br/>
            <span className="text-foreground/40">Zigla Pakala</span>
          </motion.h1>
          <motion.p
        ...
        {/* Stats Grid */}
        <motion.div
          className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.04] border border-white/[0.04] mb-24 md:mb-32"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-background p-8 md:p-10 flex flex-col justify-center" data-testid="stat-impact-1">
            ...
            <div className="font-mono text-[10px] text-foreground/40 uppercase tracking-widest">Well Built</div>
          </div>
          ...
          <div className="bg-background p-8 md:p-10 flex flex-col justify-center" data-testid="stat-impact-3">
            ...
            <div className="font-mono text-[10px] text-foreground/40 uppercase tracking-widest">Total Raised</div>
          </div>
          <div className="bg-background p-8 md:p-10 flex flex-col justify-center" data-testid="stat-impact-4">
            <div className="font-display text-3xl md:text-4xl font-bold text-foreground/70 mb-2">{impactData.stats.targetGoal}</div>
            <div className="font-mono text-[10px] text-primary/70 uppercase tracking-widest">Next Goal</div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-32 items-start">
          ...
          >
            ...
            <div className="mt-6 border-l border-primary/30 pl-4">
              <p className="text-sm text-foreground/45 italic font-light leading-relaxed">
          ...
          <div className="space-y-16">
            {impactData.timeline.map((item, i) => (
              ...
              >
                <div className="font-mono text-[10px] text-primary/60 uppercase tracking-[0.18em] mb-4">Phase 0{i + 1}</div>
                <h3 className="font-display text-3xl font-bold uppercase tracking-tighter mb-4">{item.phase}</h3>
                <p className="text-base text-foreground/55 font-light leading-relaxed">
                  {item.description}
                </p>
                {i < impactData.timeline.length - 1 && (
                  <div className="hidden lg:block absolute -bottom-16 left-0 w-px h-12 bg-white/[0.06]" />
                )}
              </motion.div>
            ))}
            ...
            >
              ...
              <p className="text-foreground/50 mb-8 font-light leading-relaxed">
