    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden" data-testid="section-hero">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-background/60 bg-gradient-to-t from-background via-background/40 to-transparent z-10" />
          <img 
            src="/images/hero.png" 
            alt="Atmospheric Berlin club crowd" 
            className="w-full h-full object-cover object-center grayscale mix-blend-luminosity opacity-40"
        ...
        <div className="container relative z-20 px-4 md:px-6 pt-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p 
              className="text-lg md:text-2xl text-foreground/80 mb-10 max-w-2xl mx-auto font-medium"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <Link href="/get-involved">
                <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-none border-foreground hover:bg-foreground hover:text-background font-bold tracking-widest uppercase text-sm px-8 py-6 h-auto" data-testid="button-hero-involved">
                  Support the Mission
                </Button>
              </Link>
            </motion.div>
      ...
      {/* CONCEPT INTRO */}
      <section className="py-24 md:py-32 bg-background border-b border-border" data-testid="section-concept">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <motion.div className="lg:col-span-7 flex flex-col justify-center" variants={fadeIn}>
              <p className="text-xl md:text-2xl text-foreground/80 leading-relaxed font-serif">
              ...
              <div className="mt-8">
                <Link href="/about">
                  <span className="inline-flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-sm hover:underline underline-offset-8 cursor-pointer group" data-testid="link-concept-about">
                    Read our story
        ...
        <section className="py-24 md:py-32 bg-card" data-testid="section-featured-event">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              ...
              >
                <Link href="/events">
                  <span className="uppercase tracking-widest text-sm font-bold text-foreground/60 hover:text-foreground cursor-pointer flex items-center gap-2 group" data-testid="link-all-events">
                    All Events
            ...
            <motion.div 
              className="group relative border border-border hover:border-primary/50 transition-colors overflow-hidden"
              initial={{ opacity: 0, y: 30 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-card">
                  <div className="flex items-center gap-4 mb-6">
                    <span className="bg-primary text-primary-foreground px-3 py-1 font-mono text-xs font-bold uppercase tracking-widest" data-testid="text-featured-date">
                      {new Date(upcomingEvents[0].date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                    </span>
                    <span className="font-mono text-xs text-foreground/50 uppercase tracking-widest" data-testid="text-featured-venue">
                  ...
                  <p className="text-foreground/70 mb-10 text-lg" data-testid="text-featured-desc">
      ...
      {/* IMPACT HIGHLIGHT */}
      <section className="py-24 md:py-32 bg-background border-y border-border" data-testid="section-impact">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <span className="text-primary font-mono text-sm tracking-widest uppercase mb-4 block">Direct Action</span>
              ...
              <div className="grid grid-cols-2 gap-8 mb-10">
                <div>
                  ...
                  <div className="font-mono text-xs text-foreground/60 uppercase tracking-widest">Raised to date</div>
                </div>
                <div>
              ...
              <Link href="/impact">
                <Button variant="outline" className="rounded-none border-foreground hover:bg-foreground hover:text-background font-bold tracking-widest uppercase h-14 px-8" data-testid="button-impact-report">
                  View Full Report
                </Button>
              </Link>
            </motion.div>
            ...
            <motion.div
              className="relative aspect-square lg:aspect-[4/5] bg-muted overflow-hidden border border-border"
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 z-20 flex justify-between items-end">
                <span className="font-mono text-xs uppercase tracking-widest font-bold bg-background/80 backdrop-blur px-3 py-1 border border-border" data-testid="text-impact-location">
      ...
      <section className="py-24 md:py-32 bg-card" data-testid="section-get-involved">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p className="text-foreground/70 text-lg">Multiple ways to plug into the mission.</p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn}>
                <Link href={item.link}>
                  <div className="h-full bg-background border border-border p-8 hover:border-primary transition-colors group cursor-pointer" data-testid={`card-involved-${item.title.toLowerCase()}`}>
                    <item.icon size={32} className="text-primary mb-6 group-hover:scale-110 transition-transform" />
                    <h3 className="font-display text-2xl font-bold uppercase tracking-tight mb-3">{item.title}</h3>
      ...
      {/* PARTNERS STRIP */}
      <section className="py-16 border-y border-border bg-background overflow-hidden" data-testid="section-partners">
        <div className="container px-4 md:px-6">
          <p className="text-center font-mono text-xs text-foreground/40 uppercase tracking-widest mb-10">Supported by the scene</p>
          <div className="flex flex-wrap justify-center gap-12 md:gap-20 items-center opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            {partners.map((partner, i) => (
              <div key={i} className="font-display font-bold text-xl md:text-3xl uppercase tracking-tighter" data-testid={`text-partner-${i}`}>
                {partner.name}
              </div>
            ))}
          </div>
